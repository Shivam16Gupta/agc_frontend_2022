...
class ReExRegisteration extends Component {
  constructor() {
    super()
    this.state = {
      isChecked: false,
      ...
      if (
        ...
        if (activatedCourse[course].includes(admissionYear)) {
          if (!token) {
            ...
            data.append('mobile', universityRoll)
            data.append('dob', dob)
            data.append('gender', enrollmentNo)
                ...
                <Grid container spacing={2} alignItems="center">
                  ...
                  <Grid item xs={12}>
                    <CustomInput
                      ...
                      handleChange={this.handleChangeFields}
                      errorMsg={
                        'Mother Name must be min. of 5 and max. 50 character'
                      }
                    />
                  </Grid>
                  {/* <Grid item md={6} xs={12}>
...
export default withRouter(withStyles(useStyles)(ReExRegisteration))
